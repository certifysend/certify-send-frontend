...
const FormBuilder = ({ onClose }) => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen max-w-7xl mx-auto mt-10">
      <div className="bg-[#E5E7EB] py-3 px-4 md:flex justify-between items-center">
          ...
          <div className="flex text-xs bg-white rounded-md shadow-sm">
            <span
              className={`px-3 py-2 rounded-l-md font-medium flex items-center gap-1 cursor-pointer ${
                activeTab === "questions"
                  ? "bg-[#F3F3F3] border border-[#E8E8E8]"
                  : "bg-[#FFFFFF] text-gray-400 border-1 border-r border-[#E4E7EC]"
              }`}
              onClick={() => handleTabClick("questions")}
            >
              Questions{" "}
              <span className="bg-black text-white rounded-full h-4 w-4 inline-flex items-center justify-center text-xs">
                1
              </span>
            </span>
            <span
            ...
            <span
              className={`px-3 py-2 flex items-center gap-0.5 cursor-pointer rounded-r-md ${
                activeTab === "settings"
                  ? "bg-[#F3F3F3] border border-[#E8E8E8]"
                  : "bg-[#FFFFFF] text-gray-400 border-1 border-[#E4E7EC]"
              }`}
      ...
      <div className="flex flex-col lg:flex-row bg-[#F9FAFB] mt-5 h-full">
        <div className="w-full lg:w-56 bg-white p-4 relative order-2 lg:order-1">
          <div className="mb-4">
            <div
          ...
          <div className="bg-[#FFF6EE] border rounded-md p-3 text-xs absolute bottom-4 left-4 right-4">
            <div className="flex items-center">
              <div className="h-5 w-5 bg-yellow-400 rounded-full flex items-center justify-center text-white font-bold text-xs">
                !
              </div>
        ...
        <div className="flex-1 p-4 order-1 lg:order-2">
          {activeTab === "questions" && (
            <div>
              <div className="relative mb-4">
                <img src="/img/image.png" alt="Form Header" className="w-full h-auto object-cover rounded-lg" />
              </div>
                  ...
                  >
                    <div className="flex items-start mb-1">
                      <div className="mr-2 mt-0.5">
                        ...
                        >
                          {selectedOption === "thank-you-page" && <div className="w-2 h-2 bg-white rounded-full"></div>}
                        </div>
                      </div>
                      <div>
                  ...
                  >
                    <div className="flex items-start">
                      <div className="mr-2 mt-0.5">
                        ...
                        >
                          {selectedOption === "external-link" && <div className="w-2 h-2 bg-white rounded-full"></div>}
                        </div>
                      </div>
                      <div>
                ...
                {selectedOption === "external-link" && (
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Redirect using HTTP POST to send submission data to the target page, ensuring the page supports
                      HTTP POST requests.
                    </p>
                  </div>
                )}
          ...
          <div className="bg-white shadow-lg rounded-lg max-w-6xl mx-auto p-10 space-y-8">
            <div className="bg-white p-4 shadow-lg">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => setShowPopup(false)} className="hover:text-gray-700 border border-gray-100">
                  <X size={25} />
                </button>
              </div>
