...
export default function SignUp() {
  ...
  const { currentStep, setCurrentStep, totalSteps } = useContext(ProgressContext); // Use context

  return (
    <div className="flex min-h-screen bg-gray-50">
      <div className="w-full lg:w-1/2 bg-white flex flex-col px-8 lg:px-[72px] py-20">
    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full px-3.5 py-2.5 border border-[#D0D5DD] rounded-lg focus:ring-2 focus:ring-[#5570F1] focus:border-transparent"
          required
        />
      </div>
      ...
      <div className="flex items-start">
        <input
          ...
          onChange={handleChange}
          className="mt-1 h-4 w-4 rounded border-[#D0D5DD] text-[#5570F1] focus:ring-[#5570F1]"
          required
        />
        <p className="ml-2 text-xs text-[#667085]">
      ...
      <button
          ...
          className="w-full bg-[#5570F1] text-white px-[18px] py-2.5 rounded-lg font-semibold text-[14px] hover:bg-[#5570F1]/90 transition-colors"
        >
      ...
      <div className="relative my-8">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center justify-center gap-3 px-[18px] py-2.5 bg-white border border-[#D0D5DD] rounded-lg text-[#344054] text-sm font-semibold hover:bg-gray-50 transition-colors">
        ...
        <p className="mt-6 text-center text-sm text-[#8B8D97]">
          Already have an account?{" "}
          <Link href="/login" className="text-[#5570F1] hover:underline">
            Log in
          </Link>
        </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6">
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="block text-sm font-medium text-[#344054]">Company/Institution Email</label>
          <input
            type="email"
            name="email"
            value={formData.email}
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center border border-[#D0D5DD] rounded-lg focus-within:ring-2 focus-within:ring-[#5570F1] focus-within:border-transparent">
            <select className="bg-transparent outline-none text-gray-900 mr-2 pl-3.5 py-2.5 border-r border-[#D0D5DD]">
              <option>+234</option>
              <option>+1</option>
              <option>+44</option>
            </select>
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-transparent outline-none text-gray-900"
              required
            />
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-[#5570F1] text-white px-[18px] py-2.5 rounded-lg font-semibold text-[14px] hover:bg-[#5570F1]/90 transition-colors"
        >
          <Link to="/institution-details">Continue</Link>
        </button>
        ...
        Already have an account?{" "}
        <Link to="/login" className="text-[#5570F1] font-medium hover:underline">
          Sign in
        </Link>
        </p>
